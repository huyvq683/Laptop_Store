...
public class ViewSP extends javax.swing.JFrame {
    ...
    private void btnThemSPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemSPActionPerformed
        ...
        SanPham sp = new SanPham("SP0" + (listSanPham.size()), txtTenSP.getText(), new Date(), new Date());
    ...
    private void btnSuaSPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaSPActionPerformed
        SanPham sPham = listSanPham.get(tblSanPham.getSelectedRow());
        SanPham sp = new SanPham(txtMaSP.getText(), txtTenSP.getText(), new Date(), sPham.getAlstModifiedDate());
        UUID id = sp.getId();
    ...
    private void btnXoaSPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaSPActionPerformed
        SanPham sPham = listSanPham.get(tblSanPham.getSelectedRow());
        SanPham sp = new SanPham(txtMaSP.getText(), txtTenSP.getText(),sPham.getCreatedDate(), sPham.getAlstModifiedDate());
        UUID id = sp.getId();
