...
public class ViewCPU extends javax.swing.JFrame {
    ...
    CPUService service = new CPUServiceImql();
    List<CPU> list = service.getAll();

    /**
     * Creates new form ViewCPU
     */
    public ViewCPU() {
        initComponents();
    ...
    private void fill(int index) {
        CPU sp = list.get(index);
        txtMaCPU.setText(sp.getMa());
        txtTenCPU.setText(sp.getTen());
    }

    private void showDataTable(List<CPU> list) {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtTenCPU, javax.swing.GroupLayout.DEFAULT_SIZE, 150, Short.MAX_VALUE))
    ...
    private void btnThemSPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemSPActionPerformed
        CPU sp = new CPU("CPU0"+(list.size()), txtTenCPU.getText(), new Date(), new Date());
    ...
    private void btnSuaSPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaSPActionPerformed
        CPU sPham = list.get(tblCPU.getSelectedRow());
        CPU sp = new CPU("CPU0"+(list.size()), txtTenCPU.getText(), new Date(), sPham.getAlstModifiedDate());
        UUID id = sp.getId();
    ...
    private void btnXoaSPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaSPActionPerformed
        CPU sPham = list.get(tblCPU.getSelectedRow());
        CPU sp = new CPU("CPU0"+(list.size()), txtTenCPU.getText(), sPham.getCreatedDate(), sPham.getAlstModifiedDate());
        UUID id = sp.getId();
