 ...
 * @author FPT
 */
public class PalelSanPham extends javax.swing.JFrame {
...
//        CbbSP();
    ...
    private void initComponents() {
        ...
        btnSua2.setBackground(new java.awt.Color(0, 51, 51));
        ...
        buttonGroup1.add(rbNgungHoatDong);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PalelSanPham.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PalelSanPham().setVisible(true);
            }
        });
    }
