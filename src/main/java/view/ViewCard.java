...
public class ViewCard extends javax.swing.JFrame {
    ...
    CardService service = new CardServiceImql();
    List<CardMH> list = service.getAll();

    /**
     * Creates new form ViewCard
     */
    public ViewCard() {
        initComponents();
    ...
    private void fill(int index) {
        CardMH sp = list.get(index);
        txtMaCard.setText(sp.getMa());
        txtTenCard.setText(sp.getTen());
    }

    private void showDataTable(List<CardMH> list) {
        model = (DefaultTableModel) tblCard.getModel();
        model.setRowCount(0);
        for (CardMH x : list) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Mã Card");

        jLabel2.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel2.setText("Tên Card");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtTenCard, javax.swing.GroupLayout.DEFAULT_SIZE, 150, Short.MAX_VALUE))
    ...
    private void btnXoaSPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaSPActionPerformed
        CardMH sPham = list.get(tblCard.getSelectedRow());
        CardMH sp = new CardMH("Card0"+(list.size()), txtTenCard.getText(), sPham.getCreatedDate(), sPham.getAlstModifiedDate());
        UUID id = sp.getId();
    ...
    private void btnSuaSPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaSPActionPerformed
        CardMH sPham = list.get(tblCard.getSelectedRow());
        CardMH sp = new CardMH("Card0"+(list.size()), txtTenCard.getText(), new Date(), sPham.getAlstModifiedDate());
        UUID id = sp.getId();
    ...
    private void btnThemSPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemSPActionPerformed
        CardMH sp = new CardMH("Card0" + (list.size()), txtTenCard.getText(), new Date(), new Date());
